...
//
// Aesthetic register: Coleran's pragmatic-futurism (engineering precision
// over Iron Man cosplay), edge telemetry density (Tony's monitor corners),
// Black Mirror's concentric ring nav. We compose bubbletea/lipgloss + a
// few hand-rolled braille primitives. There's no sci-fi HUD library for
// Go yet; shape these primitives so they can be extracted into one later.
package main
